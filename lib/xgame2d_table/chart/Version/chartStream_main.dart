...
// class ChartStreamPageMain extends StatefulWidget {
//   const ChartStreamPageMain({Key? key}) : super(key: key);
//   @override
//   State<ChartStreamPageMain> createState() => _ChartStreamPageMainState();
// }

// class _ChartStreamPageMainState extends State<ChartStreamPageMain> {
//   @override
...
//   initialChip =transformAndTruncate( combined.map((e) => e['data1'] as int).toList());
//   nextChip =transformAndTruncate( combined.map((e) => e['data2'] as int).toList());
//   valueDisplay = transformAndRoundOriginal(combined.map((e) => (e['data2'] as int).toInt()).toList());
//   valueDisplayPrev = transformAndRoundOriginal(combined.map((e) => (e['data1'] as int).toInt()).toList());

//   // Update rawData
//   rawData[0] = inputNumber;
//   rawData[1] = initialChip;
//   rawData[2] = nextChip;

//   debugPrint('inputNumber Sorted Keys: $inputNumber');
//   debugPrint('Members Sorted : $members');
//   debugPrint('initialChip Sorted Data[1]: $initialChip');
//   debugPrint('nextChip Sorted Data[2]: $nextChip');
//   debugPrint('valueDisplay & valueDisplayPrev : $valueDisplay - $valueDisplayPrev');
// }
// }
